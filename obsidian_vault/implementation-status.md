...
- **[ANK-039] CI-equivalent clippy validation (--all-targets --all-features)** (todo, med): ยืนยัน lint path เดียวกับ CI โดยรัน cargo clippy --all-targets --all-features -- -D warnings ใน environment ที่พร้อม libclang/bindgen.
